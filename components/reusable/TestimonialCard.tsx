...
const TestimonialCard = () => {
  ...
  return (
    <div className="mt-10 w-full  xl:max-w-340 items-center 2xl:items-start     mx-auto bg-white rounded-4xl p-5 flex flex-col 2xl:flex-row gap-8">
      <Image
        src={thumb}
        alt="thumb"
        width={100}
      ...
      <div className="flex flex-col justify-between w-full 2xl:max-w-[40%]">
        ...
        <div className="mt-5 flex lg:text-[16px] flex-wrap gap-3">
        ...
        <div className="mt-6">
          <p className="font-bold text-5xl clashDisplay">$2M</p>
